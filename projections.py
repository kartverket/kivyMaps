...
# !NOTE! This method maps the underlying lat/lon system with global bounds
# !HACK! to a different custom projection and bounds. This is not a proper reprojection
